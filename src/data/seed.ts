...
export const HOTELS: Hotel[] = [
  {
    ...
    province: 'Airai',
    additionalRegions: ['Koror (ROR-Palau Intl.)'],
    chainBrand: '',
    fax: '',
    postCode: '32713',
    email: '',
    ...
    descriptions: lt(
      'Hoa Binh Independence Hotel offers comfortable rooms and attentive service, conveniently located for both business and leisure travellers.',
      '호아빈 독립 호텔은 편안한 객실과 세심한 서비스를 제공하며, 비즈니스와 레저 여행객 모두에게 편리한 위치에 있습니다.',
      'ホアビン独立ホテルは快適な客室と行き届いたサービスを提供し、ビジネスにもレジャーにも便利な立地です。',
      'Khách sạn Độc Lập Hòa Bình mang đến phòng nghỉ thoải mái và dịch vụ chu đáo, vị trí thuận tiện cho cả công tác và nghỉ dưỡng.',
      '和平独立酒店提供舒适的客房和周到的服务，地理位置优越，适合商务和休闲旅客。',
    ),
    checkIn: '14:00',
    checkOut: '12:00',
  ...
  },
  {
    ...
    registerStatus: 'Approved',
    province: 'Seoul',
    additionalRegions: ['Gwanghwamun', 'Jung-gu'],
    chainBrand: 'Ohmy Collection',
    fax: '82-2-733-0551',
    postCode: '04520',
    address: '120 Sejong-daero, Jung-gu, Seoul, South Korea',
    addresses: lt('120 Sejong-daero, Jung-gu, Seoul', '서울 중구 세종대로 120', '', '', ''),
    ...
    descriptions: lt(
      'A flagship 5-star property in downtown Seoul overlooking Gyeongbokgung Palace, featuring a spa, indoor pool, and three signature restaurants.',
      '경복궁이 내려다보이는 서울 도심의 5성급 대표 호텔로 스파, 실내 수영장, 3개의 시그니처 레스토랑을 갖추고 있습니다.',
      'ソウル都心にあり景福宮を望む5つ星の旗艦ホテル。スパ、屋内プール、3つのシグネチャーレストランを備えています。',
      'Khách sạn 5 sao hàng đầu tại trung tâm Seoul nhìn ra Cung Gyeongbokgung, có spa, hồ bơi trong nhà và ba nhà hàng đặc trưng.',
      '首尔市中心的五星级旗舰酒店，俯瞰景福宫，设有水疗中心、室内泳池和三家招牌餐厅。',
    ),
    checkIn: '15:00',
    checkOut: '11:00',
  ...
  },
  {
    ...
    registerStatus: 'Approval Pending',
    province: 'Osaka',
    additionalRegions: ['Minato-ku'],
    chainBrand: '',
    fax: '81-6-6555-0001',
    postCode: '552-0022',
    address: '1-9 Kaigan-dori, Minato-ku, Osaka, Japan',
    addresses: lt('1-9 Kaigan-dori, Minato-ku, Osaka', '', '大阪市港区海岸通1-9', '', ''),
    ...
    descriptions: lt(
      'A relaxed 4-star bayside resort near Osaka Bay, offering sea-view rooms, an onsen, and easy access to Universal Studios Japan.',
      '오사카 베이 인근의 편안한 4성급 해변 리조트로 오션뷰 객실, 온천, 유니버설 스튜디오 재팬으로의 편리한 접근성을 제공합니다.',
      '大阪湾近くのくつろげる4つ星ベイサイドリゾート。オーシャンビューの客室、温泉、USJへの好アクセスを提供します。',
      'Khu nghỉ dưỡng ven vịnh 4 sao thư giãn gần Vịnh Osaka, có phòng nhìn ra biển, suối nước nóng và thuận tiện đến Universal Studios Japan.',
      '大阪湾附近轻松惬意的四星级海湾度假村，提供海景客房、温泉，并可便捷前往日本环球影城。',
    ),
    checkIn: '15:00',
    checkOut: '10:00',
